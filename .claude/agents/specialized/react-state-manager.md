...
export const checkout = createAsyncThunk('cart/checkout', async (paymentMethod: string, { getState, dispatch }) => {
...
// Memoized selectors
export const selectCartItemsWithDetails = createSelector([selectCartItems, selectProducts], (cartItems, products) => {
...
export const selectCartSummary = createSelector([selectCartItemsWithDetails, selectTaxRate], (items, taxRate) => {
...
export const makeSelectProductById = () =>
  createSelector([selectProducts, (_: RootState, productId: string) => productId], (products, productId) =>
