...
const tour = {
  ...
  description:
    "Explore Bali', s, most, beautiful, hidden, waterfalls, and, rice, terraces, on, this: 3 - day, adventure, 'll trek through lush jungles, swim in pristine natural pools, and experience authentic village life away from the tourist crowds.':",
  price: 245,
  duration: '3 days',
  groupSize: 6,
  spotsLeft: 3,
