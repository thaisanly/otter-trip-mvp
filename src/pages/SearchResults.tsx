...
const interestIcons = {
  ...
  Food: <UtensilsIcon size={16} />,
  Photography: <CameraIcon size={16} />,
  Wellness: <HeartIcon size={16} />,
...
const personalityIcons = {
  ...
  Educational: <GraduationCapIcon size={16} />,
  Social: <UsersIcon size={16} />,
  'Solo-friendly': <UserPlusIcon size={16} />,
  'Family-oriented': <UsersIcon size={16} />,
  'Art-lover': <PaletteIcon size={16} />,
