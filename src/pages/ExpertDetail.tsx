...
const expertsData = {
  'sarah-chen': {
    ...
    coverImage: 'https://images.unsplash.com/photo-1596422846543-75c6fc197f11?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
    location: 'Singapore',
    countryCode: '🇸🇬',
    verified: true,
    rating: 4.9,
    ...
    upcomingStreams: [{
      ...
      date: 'May 15, 2023',
      time: '7:00 PM SGT',
      thumbnail: 'https://images.unsplash.com/photo-1543731068-7e0f5beff43a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80'
    }, {
      id: 'stream-2',
      title: 'Singapore Night Safari Experience',
      date: 'May 20, 2023',
      time: '8:30 PM SGT',
      thumbnail: 'https://images.unsplash.com/photo-1576085898323-218337e3e43c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80'
    }],
    latestVideos: [{
      id: 'video-1',
      ...
      duration: '12:45',
      views: '24K',
      thumbnail: 'https://images.unsplash.com/photo-1525625293386-3f8f99389edd?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80'
    }, {
      id: 'video-2',
      title: 'Singapore Street Food Guide',
      duration: '18:32',
      views: '56K',
      thumbnail: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80'
    }, {
      id: 'video-3',
      title: 'Gardens by the Bay Night Tour',
      duration: '15:17',
      views: '32K',
      thumbnail: 'https://images.unsplash.com/photo-1506351421178-63b52a2d2562?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80'
    }]
  },
  'marco-rodriguez': {
    id: 'marco-rodriguez',
    ...
    coverImage: 'https://images.unsplash.com/photo-1558642084-fd07fae5282e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
    location: 'Barcelona',
    countryCode: '🇪🇸',
    verified: true,
    rating: 4.8,
    ...
    upcomingStreams: [{
      ...
      date: 'May 18, 2023',
      time: '6:00 PM CEST',
      thumbnail: 'https://images.unsplash.com/photo-1594394489098-74ca7267182a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80'
    }],
    latestVideos: [{
      id: 'video-1',
      ...
      duration: '16:24',
      views: '37K',
      thumbnail: 'https://images.unsplash.com/photo-1539037116277-4db20889f2d4?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80'
    }, {
      id: 'video-2',
      title: 'Best Tapas Bars in Barcelona',
      duration: '14:18',
      views: '42K',
      thumbnail: 'https://images.unsplash.com/photo-1515443961218-a51367888e4b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80'
    }]
  },
  'yuki-tanaka': {
    id: 'yuki-tanaka',
    ...
    coverImage: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
    location: 'Tokyo',
    countryCode: '🇯🇵',
    verified: true,
    rating: 4.7,
    ...
    latestVideos: [{
      ...
      views: '18K',
      thumbnail: 'https://images.unsplash.com/photo-1554797589-7241bb691973?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80'
    }, {
      id: 'video-2',
      title: 'Ultimate Guide to Japanese Street Food',
      duration: '20:12',
      views: '32K',
      thumbnail: 'https://images.unsplash.com/photo-1521856729154-7118f7181af9?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80'
    }]
  },
  'david-thompson': {
    id: 'david-thompson',
    ...
    coverImage: 'https://images.unsplash.com/photo-1520986606214-8b456906c813?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
    location: 'London',
    countryCode: '🇬🇧',
    verified: true,
    rating: 4.9,
    ...
    upcomingStreams: [{
      ...
      date: 'May 22, 2023',
      time: '2:00 PM BST',
      thumbnail: 'https://images.unsplash.com/photo-1592509255531-161181e0cb8d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80'
    }],
    latestVideos: [{
      id: 'video-1',
      ...
      duration: '22:15',
      views: '45K',
      thumbnail: 'https://images.unsplash.com/photo-1588953936179-d2a4734c5490?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80'
    }, {
      id: 'video-2',
      title: "London's, Medieval, Mysteries",
      views: '38K',
      thumbnail: 'https://images.unsplash.com/photo-1533929736458-ca588d08c8be?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80'
    }]
  }
};
...
const ExpertDetail = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (aboutRef.current && scrollPosition < aboutRef.current.offsetTop + aboutRef.current.offsetHeight) {
        setActiveTab('about');
      } else if (toursRef.current && scrollPosition < toursRef.current.offsetTop + toursRef.current.offsetHeight) {
        setActiveTab('tours');
    ...
    return <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center p-6 max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            We couldn't find the expert you're looking for. They may have moved
            or the link might be incorrect.
          </p>
          <button onClick={handleBackClick} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
            Back to Experts
          </button>
        </div>
      </div>;
  ...
  return <div className="bg-gray-50 min-h-screen pb-12">
      ...
      <div className="relative h-[400px] md:h-[500px]">
        <img src={expertData.coverImage} alt={`${expertData.name}'s cover`} className="w-full h-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent"></div>
        {/* Breadcrumb */}
        <div className="absolute top-4 left-0 w-full">
          <div className="container mx-auto px-4">
            <div className="flex items-center text-sm text-white">
              <button onClick={handleBackClick} className="flex items-center hover:text-blue-200 transition-colors mr-2">
        ...
        {expertData.audioTrack && <div className="absolute bottom-4 right-4 flex items-center bg-black/40 backdrop-blur-sm rounded-full px-3 py-1.5 text-white">
            ...
            <input type="range" min="0" max="100" value={volume} onChange={handleVolumeChange} className="w-20 h-1 bg-white/30 rounded-full appearance-none [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white" aria-label="Volume control" />
          </div>}
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center md:items-end">
              <div className="w-32 h-32 md:w-36 md:h-36 rounded-full border-4 border-white overflow-hidden -mt-16 md:mt-0 mb-4 md:mb-0 md:mr-6 relative z-10 bg-white shadow-lg group cursor-pointer">
                <img src={expertData.image} alt={expertData.name} className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105" />
                {expertData.verified && <div className="absolute bottom-1 right-1 bg-blue-500 text-white p-1 rounded-full">
                    <CheckCircleIcon size={16} />
                  </div>}
                {expertData.isLive && <div className="absolute top-2 right-2 w-4 h-4 bg-red-600 rounded-full border-2 border-white animate-pulse"></div>}
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div>
                    <h1 className="text-3xl md:text-4xl font-bold mb-1 flex items-center justify-center md:justify-start">
                      {expertData.name}
                      {expertData.verified && <CheckCircleIcon size={20} className="ml-2 text-blue-400" />}
                    </h1>
      ...
      <div ref={navRef} className={`${isNavSticky ? 'sticky top-0 shadow-md' : 'relative'} bg-white border-b border-gray-200 z-30 transition-shadow duration-300`}>
        <div className="container mx-auto px-4">
          <div className="flex overflow-x-auto">
            <button className={`px-6 py-4 font-medium text-sm whitespace-nowrap transition-colors ${activeTab === 'about' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600 hover:text-gray-900'}`} onClick={() => scrollToSection('about')}>
              <UserIcon size={16} className="inline mr-1.5" />
              About Me
            </button>
            <button className={`px-6 py-4 font-medium text-sm whitespace-nowrap transition-colors ${activeTab === 'tours' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600 hover:text-gray-900'}`} onClick={() => scrollToSection('tours')}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {expertData.specialties.map((specialty, index) => <span key={index} className="bg-blue-50 text-blue-700 px-3 py-1 rounded-full text-sm">
                        {specialty}
                      </span>)}
                  </div>
                  <h3 className="font-medium text-gray-900 mb-3">Languages</h3>
                  <div className="flex flex-wrap gap-2">
                    {expertData.languages.map((language, index) => <div key={index} className="flex items-center bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm">
            ...
            <section id="tours" ref={toursRef} className="mb-12">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex bg-gray-100 rounded-lg p-1">
                  <button className={`px-4 py-1.5 rounded-md text-sm font-medium transition-colors ${tourFilter === 'upcoming' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-700 hover:text-gray-900'}`} onClick={() => setTourFilter('upcoming')}>
                    Upcoming
                  </button>
                  <button className={`px-4 py-1.5 rounded-md text-sm font-medium transition-colors ${tourFilter === 'past' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-700 hover:text-gray-900'}`} onClick={() => setTourFilter('past')}>
                    Past Tours
                  </button>
                </div>
              </div>
              {tourFilter === 'upcoming' ? <div className="space-y-6">
                  {expertData.featuredTours.map(tour => <div key={tour.id} className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
                  ...
                  <div className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
                    <div className="flex flex-col md:flex-row">
                      <div className="md:w-1/3 h-48 md:h-auto relative">
                        <img src="https://images.unsplash.com/photo-1545569341-9eb8b30979d9?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80" alt="Singapore Night Safari" className="w-full h-full object-cover" />
                      ...
                      <div className="p-6 flex-1">
                        ...
                        <p className="text-gray-600 text-sm mb-3">
                          Experience Singapore's famous Night Safari with a
                          guided tour through the nocturnal animal habitats.
                        </p>
                        <div className="flex flex-wrap gap-4 mb-4 text-sm">
                          <div className="flex items-center text-gray-700">
                  ...
                  <div className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
                    <div className="flex flex-col md:flex-row">
                      <div className="md:w-1/3 h-48 md:h-auto relative">
                        <img src="https://images.unsplash.com/photo-1565967511849-76a60a516170?ixlib=rb-4.0.3&auto=format&fit=crop&w=1024&q=80" alt="Historical Singapore Tour" className="w-full h-full object-cover" />
                        <div className="absolute top-2 right-2 bg-gray-800 text-white text-xs px-2 py-1 rounded-full">
                          Past Tour
                        </div>
                      </div>
                      <div className="p-6 flex-1">
                        ...
                        <p className="text-gray-600 text-sm mb-3">
                          Discover Singapore's rich colonial history and the
                          stories behind its iconic landmarks and monuments.
                        </p>
                        <div className="flex flex-wrap gap-4 mb-4 text-sm">
                          <div className="flex items-center text-gray-700">
            ...
            <section id="social" ref={socialRef} className="mb-12">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
                <h3 className="font-medium text-gray-900 mb-4">
                  Connect with {expertData.name}
                </h3>
                <div className="flex flex-wrap gap-3">
                  {expertData.socialLinks.instagram && <a href={expertData.socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg">
                      <InstagramIcon size={18} className="mr-2" />
                      Instagram
                    </a>}
                  {expertData.socialLinks.youtube && <a href={expertData.socialLinks.youtube} target="_blank" rel="noopener noreferrer" className="flex items-center px-4 py-2 bg-red-600 text-white rounded-lg">
                      <YoutubeIcon size={18} className="mr-2" />
                      YouTube
                    </a>}
                  {expertData.socialLinks.twitter && <a href={expertData.socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="flex items-center px-4 py-2 bg-blue-400 text-white rounded-lg">
                      <TwitterIcon size={18} className="mr-2" />
                      Twitter
                    </a>}
                  {expertData.socialLinks.facebook && <a href={expertData.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg">
                      <FacebookIcon size={18} className="mr-2" />
                      Facebook
                    </a>}
                  {expertData.socialLinks.linkedin && <a href={expertData.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center px-4 py-2 bg-blue-700 text-white rounded-lg">
              ...
              {/* Latest Videos */}
              {expertData.latestVideos && expertData.latestVideos.length > 0 && <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {expertData.latestVideos.map(video => <div key={video.id} className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
                  ...
                  <div className="flex items-center mb-4 md:mb-0">
                    <div className="mr-4 text-center">
                      ...
                      <div className="flex mt-1">
                        {[...Array(5)].map((_, i) => <StarIcon key={i} size={16} className={i < Math.floor(expertData.rating) ? 'text-yellow-400 fill-current' : 'text-gray-300'} />)}
                      </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border-b border-gray-100 pb-6">
                      <div className="flex items-start mb-3">
                        <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=128&q=80" alt="John D." className="w-10 h-10 rounded-full mr-3" />
                        <div className="flex-1">
                          <div className="flex justify-between items-start">
                            <div>
                              ...
                              <div className="flex items-center">
                                <div className="flex">
                                  {[...Array(5)].map((_, i) => <StarIcon key={i} size={14} className={i < 5 ? 'text-yellow-400 fill-current' : 'text-gray-300'} />)}
                                </div>
                          ...
                          <p className="text-gray-700 mt-2">
                            Sarah was an amazing guide! She took us to places we
                            would never have found on our own and shared
                            fascinating stories about Singapore's food culture.
                            The hawker center tour was the highlight of our
                            trip!
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="border-b border-gray-100 pb-6">
                      <div className="flex items-start mb-3">
                        <img src="https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?ixlib=rb-4.0.3&auto=format&fit=crop&w=128&q=80" alt="Maria L." className="w-10 h-10 rounded-full mr-3" />
                        <div className="flex-1">
                          <div className="flex justify-between items-start">
                            <div>
                              <div className="font-medium text-gray-900">
                          ...
                          <p className="text-gray-700 mt-2">
                            We had a wonderful time exploring Singapore's
                            cultural neighborhoods with Sarah. Her knowledge of
                            the history and traditions was impressive, and she
                            was so friendly and accommodating. Highly recommend!
                          </p>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div className="flex items-start mb-3">
                        <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=128&q=80" alt="Robert T." className="w-10 h-10 rounded-full mr-3" />
                        <div className="flex-1">
                          <div className="flex justify-between items-start">
                            <div>
                              <div className="font-medium text-gray-900">
                              ...
                              <div className="flex items-center">
                                <div className="flex">
                                  {[...Array(5)].map((_, i) => <StarIcon key={i} size={14} className={i < 4 ? 'text-yellow-400 fill-current' : 'text-gray-300'} />)}
                                </div>
                                <span className="mx-2 text-gray-300">•</span>
                                <span className="text-sm text-gray-500">
                                  January 10, 2023
                          ...
                          <p className="text-gray-700 mt-2">
                            Great tour with lots of delicious food! Sarah is
                            knowledgeable and passionate about Singapore's
                            cuisine. The only reason for 4 stars instead of 5 is
                            that the tour ran a bit longer than scheduled, but
                            it was because we were having such a good time!
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <form>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Enter your name" />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Email Address
                        </label>
                        <input type="email" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Enter your email" />
                      </div>
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                      ...
                      <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="What is your inquiry about?" />
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        Message
                      </label>
                      <textarea rows={4} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Type your message here..."></textarea>
                    </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Get personalized travel planning advice from{' '}
                      {expertData?.name} in a private 1-on-1 video consultation.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <button onClick={handleBookConsultation} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center">
            ...
            <div>
              ...
              <div className="space-y-4">
                {relatedExperts.slice(0, 3).map(expert => <div key={expert.id} className="bg-white rounded-xl shadow-sm p-4 hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate(`/meet-experts/${expert.id}`)}>
                    <div className="flex items-center">
                      <div className="relative mr-3">
                        <img src={expert.image} alt={expert.name} className="w-12 h-12 rounded-full object-cover" />
                        {expert.verified && <div className="absolute -bottom-0.5 -right-0.5 bg-blue-500 text-white p-0.5 rounded-full">
              ...
              <div className="mt-4 text-center">
                <Link to="/meet-experts" className="text-blue-600 hover:text-blue-800 font-medium text-sm">
                  View All Experts
                </Link>
              </div>
            </div>
