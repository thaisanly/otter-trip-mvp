    ...
    <div className="bg-gray-50 py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto relative">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      <div className="md:w-1/3">
                        ...
                        <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                          <p className="text-sm text-gray-700 mb-3">Connected with:</p>
                          <div className="font-medium text-gray-900">{testimonial.guide.name}</div>
                          <div className="text-sm text-gray-600">{testimonial.guide.location}</div>
                        </div>
                      </div>
          ...
          {/* Navigation Buttons */}
          <button
            className="absolute top-1/2 left-0 transform -translate-y-1/2 -translate-x-4 bg-white rounded-full shadow-md p-3 hover:bg-gray-50 focus:outline-none"
            onClick={goToPrev}
          >
            <ChevronLeftIcon size={24} className="text-gray-700" />
          </button>
          <button
            className="absolute top-1/2 right-0 transform -translate-y-1/2 translate-x-4 bg-white rounded-full shadow-md p-3 hover:bg-gray-50 focus:outline-none"
            onClick={goToNext}
          >
