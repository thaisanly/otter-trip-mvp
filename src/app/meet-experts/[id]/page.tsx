...
import TikTokVideoModal from '@/components/ui/TikTokVideoModal';
...
const ExpertDetail = () => {
            ...
            if (toursResponse.ok) {
              ...
              setExpertData((prev) =>
                prev
                  ? {
                      ...prev,
                      featuredTours: toursData.featuredTours.map(
                        (tour: {
                          id: string;
                          title: string;
  ...
  const handleVideoClick = (video: { id: string; title?: string; url: string }) => {
    if (!video.url) return;

    // Check if it's a supported platform for modal playback
    ...
    const isSupported = supportedPlatforms.some((platform) => video.url.includes(platform));
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center p-6 max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            We couldn&apos;t find the expert you&apos;re looking for. They may have moved or the
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-12">
      ...
      <div
        ref={navRef}
        className={`${
          isNavSticky ? 'sticky top-0 shadow-md' : 'relative'
        } bg-white border-b border-gray-200 z-30 transition-shadow duration-300`}
      >
        <div className="container mx-auto px-4">
          <div className="flex overflow-x-auto">
            ...
            {((expertData?.socialLinks &&
              Object.keys(expertData.socialLinks).filter(
                (key) => expertData.socialLinks?.[key as keyof typeof expertData.socialLinks]
              ).length > 0) ||
              ...
              <section id="social" ref={socialRef} className="mb-12">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
                  <h3 className="font-medium text-gray-900 mb-4">
                    Connect with {expertData?.name || 'Expert'}
                  </h3>
                  ...
                  <div className="mb-8">
                    <div className="mb-4 flex items-center justify-between">
                      ...
                      <span className="text-sm text-gray-500">
                        {expertData.latestVideos.length} videos
                      </span>
                    </div>
                        ...
                        expertData.latestVideos.map((video) => {
                          ...
                          const getPlatformIcon = (url: string) => {
                            if (url.includes('tiktok.com')) {
                              return (
                                <div className="absolute top-2 left-2 bg-black text-white px-2 py-1 rounded-md text-xs font-medium flex items-center">
                                  <svg
                              ...
                              return (
                                <div className="absolute top-2 left-2 bg-red-600 text-white px-2 py-1 rounded-md text-xs font-medium flex items-center">
                              ...
                              return (
                                <div className="absolute top-2 left-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-2 py-1 rounded-md text-xs font-medium flex items-center">
                                  <InstagramIcon size={12} className="mr-1" />
                                  Instagram
                                </div>
                              );
                            }
                            ...
                            >
                              <div className="relative aspect-square bg-gray-100">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-opacity">
                                  <div className="w-14 h-14 bg-white/40 backdrop-blur-sm rounded-full flex items-center justify-center opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300 shadow-lg">
                        ...
                        <div className="flex items-start mb-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-gray-700 mt-2">
                              ...
                              found on our own and shared fascinating stories about Singapore&apos;s
                              food culture. The hawker center tour was the highlight of our trip!
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="border-b border-gray-100 pb-6">
                        <div className="flex items-start mb-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-gray-700 mt-2">
                              We had a wonderful time exploring Singapore&apos;s cultural
                              neighborhoods with Sarah. Her knowledge of the history and traditions
                              was impressive, and she was so friendly and accommodating. Highly
                              recommend!
                            </p>
                          </div>
                        </div>
              ...
              <div className="flex items-center justify-between mb-5">
                <div>
                  ...
                  <div className="text-2xl font-bold text-gray-900">
                    ${expertData?.hourlyRate || 250}/hour
                  </div>
                </div>
      ...
      <ConsultationBookingModal
        ...
        price={`$${expertData?.hourlyRate || 250}/hour`}
      />
