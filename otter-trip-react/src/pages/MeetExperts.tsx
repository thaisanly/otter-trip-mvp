...
// Sample expert data
// Experts data moved to mock file
            ...
            <div className="border-b border-gray-200 pb-6">
              ...
              <div className="space-y-3">
                <label className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-gray-500">(travel vlogs, tutorials)</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="checkbox"
                  ...
                  <span className="text-xs text-gray-500">(current and scheduled)</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="checkbox"
                  ...
                  <span className="text-xs text-gray-500">(in-person experiences)</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="checkbox"
                ...
                <label className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-gray-500">(travel gear, destinations)</span>
                </label>
              </div>
            </div>
            {/* Activity Level */}
            <div className="border-b border-gray-200 pb-6">
              ...
              <div className="space-y-3">
                <label className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-gray-500">(currently streaming)</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="radio"
                  ...
                  <span className="text-xs text-gray-500">(posted within 24h)</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="radio"
                  ...
                  <span className="text-xs text-gray-500">(active within 7 days)</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="radio"
                  ...
                  <span className="text-xs text-gray-500">(active within 30 days)</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="radio"
